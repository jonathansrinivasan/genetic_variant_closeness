...
# reset "tmp" variable
tmp<-cohort.data[!is.na(cohort.data$provean_score) & !is.na(cohort.data$revel_score) & !is.na(cohort.data$pamscore) & cohort.data$site=="Paris",]
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("lit_no_n_is_one_checkpoint.RData")
