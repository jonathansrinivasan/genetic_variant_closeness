...
This only needs to be run if you are not loading an RData that is already clean. For any saved file this has already been run.
...
This chunk is unnecessary if just loading in saved data, but joins by resnum different colums from different datasets.
...
scn5a.rmsf<- read.csv(file = "wt.scn5a.rmsf.byres.renum.csv")
scn5a.cln.d<-left_join(scn5a.cln.d, scn5a.rmsf)


scn5adist$dist_inverse<- (scn5adist$distance)^(-1)
scn5adist$dist_2inverse<- 3*(scn5adist$distance)^(-1)
scn5adist$dist_5inverse<- 5*(scn5adist$distance)^(-1)
#remove dist=0 and run it again see if that changes anything because sequenced is running it through the function so maybe thatll fix it
na.rm(scn5adist$distance = 0)
scn5adist <- scn5adist[scn5adist$distance!=0]

```
This chunk includes all of the data being run through the func_dist_seq file and rmsf calculations. It is long to spell out exactly what I ran the data through. At the moment, 
```{r, echo=FALSE, warning=FALSE, message=FALSE}
load("all.brs1.data.trunc.Rdata")
# cln.d<-cln.d[cln.d$total_carriers>0,]
# cln.d$brs1_penetrance<-cln.d$brs1/cln.d$total_carriers
# 
scn5a.cln.d[, "brs1_dist_inverse"]<-NA
scn5a.cln.d[, "brs1_dist_inverse_weight"]<-NA
scn5a.cln.d[, "brs1_dist_inverse_cor"]<-NA
scn5a.cln.d[, "brs1_dist_inverse_weight_cor"]<-NA
scn5a.cln.d[, "brs1_dist_inverse_seq"]<-NA
scn5a.cln.d[, "brs1_dist_inverse_weight_seq"]<-NA
scn5a.cln.d[, "brs1_dist_2inverse"]<-NA
scn5a.cln.d[, "brs1_dist_2inverse_weight"]<-NA
scn5a.cln.d[, "brs1_dist_2inverse_cor"]<-NA
scn5a.cln.d[, "brs1_dist_2inverse_weight_cor"]<-NA
scn5a.cln.d[, "brs1_dist_2inverse_seq"]<-NA
scn5a.cln.d[, "brs1_dist_2inverse_weight_seq"]<-NA
scn5a.cln.d[, "brs1_dist_5inverse"]<-NA
scn5a.cln.d[, "brs1_dist_5inverse_weight"]<-NA
scn5a.cln.d[, "brs1_dist_5inverse_cor"]<-NA
scn5a.cln.d[, "brs1_dist_5inverse_weight_cor"]<-NA
scn5a.cln.d[, "brs1_dist_5inverse_seq"]<-NA
scn5a.cln.d[, "brs1_dist_5inverse_weight_seq"]<-NA


##correlated inverse
 for (rec in 1:nrow(scn5a.cln.d)){
   newdata<-scn5a.cln.d[!is.na(match(scn5a.cln.d$resnum, scn5adist$resnum)),]
 }
 for(rec in 1:nrow(scn5a.cln.d)){
   scn5a.cln.d<-scn5a.cln.d[!is.na(match(scn5a.cln.d$resnum, newdata$resnum)),]
 }
 for(rec in 1:nrow(scn5a.cln.d)){
   scn5a.cln.d[rec,
         c("brs1_dist_inverse_cor", "brs1_dist_inverse_weight_cor", "resnum")] <- c(funcdist(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5a.cln.d$scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_inverse'), scn5a.cln.d[rec, "resnum"])
 }
...
##sequenced inverse
 ...
 for(rec in 1:nrow(scn5a.cln.d)){
   cln.d[rec,
        c("brs1_dist_inverse_seq", "brs1_dist_inverse_weight_seq", "resnum")] <- c(funcdist2(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5a.cln.d$scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_inverse'), scn5a.cln.d[rec, "resnum"])
 }

##everything inverse
  for(rec in 1:nrow(scn5a.cln.d)){
   scn5a.cln.d[rec,
         c("brs1_dist_inverse", "brs1_dist_inverse_weight", "resnum")] <- c(funcdist(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5a.cln.d$scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_inverse'), scn5a.cln.d[rec, "resnum"])
 }


 scn5a.cln.d<- scn5a.cln.d[!is.na(scn5a.cln.d$brs1_dist_inverse),]
...
##correlated 2inverse
 ...
 for(rec in 1:nrow(scn5a.cln.d)){
   scn5a.cln.d[rec,
         c("brs1_dist_2inverse_cor", "brs1_dist_2inverse_weight_cor", "resnum")] <- c(funcdist(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5a.cln.d$scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_2inverse'), scn5a.cln.d[rec, "resnum"])
 }
...
for(rec in 1:nrow(scn5a.cln.d)){
 ...
 for(rec in 1:nrow(cln.d)){
   cln.d[rec,
        c("brs1_dist_2inverse_seq", "brs1_dist_2inverse_weight_seq", "resnum")] <- c(funcdist2(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_2inverse'), scn5a.cln.d[rec, "resnum"])
 }

##everything 2inverse
 for(rec in 1:nrow(scn5a.cln.d)){
   scn5a.cln.d[rec,
         c("brs1_dist_2inverse", "brs1_dist_2inverse_weight", "resnum")] <- c(funcdist(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5a.cln.d$scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_2inverse'), scn5a.cln.d[rec, "resnum"])
 }


 scn5a.cln.d<- scn5a.cln.d[!is.na(scn5a.cln.d$brs1_dist_2inverse),]
...
##correlated 5inverse
 ...
 for(rec in 1:nrow(scn5a.cln.d)){
   scn5a.cln.d[rec,
         c("brs1_dist_5inverse_cor", "brs1_dist_5inverse_weight_cor", "resnum")] <- c(funcdist(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5a.cln.d$scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_5inverse'), scn5a.cln.d[rec, "resnum"])
 }
...
for(rec in 1:nrow(scn5a.cln.d)){
 ...
 for(rec in 1:nrow(cln.d)){
   cln.d[rec,
        c("brs1_dist_5inverse_seq", "brs1_dist_5inverse_weight_seq", "resnum")] <- c(funcdist2(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5a.cln.d$scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_5inverse'), scn5a.cln.d[rec, "resnum"])
 }

##everything 5inverse
 for(rec in 1:nrow(scn5a.cln.d)){
   scn5a.cln.d[rec,
         c("brs1_dist_5inverse", "brs1_dist_5inverse_weight", "resnum")] <- c(funcdist(scn5a.cln.d[rec, "resnum"], scn5a.cln.d[rec, "var"], scn5a.cln.d, scn5a.cln.d$scn5adist, "brs1_penetrance", "sigmoid", 7,'dist_5inverse'), scn5a.cln.d[rec, "resnum"])
 }
...
# 
 ...
 #rmsf calculations; run this after everything through funcdist functions are correct and change it so that ideal collumns are used. For example, if the 2inverse values are correct, instead of brs1_dist_correlated, put brs1_dist_2inverse_weight_cor and same for sequenced.
 
scn5a.cln.d[, "rmsf"]<-NA
scn5a.cln.d$rmsf <- sqrt(mean((scn5a.cln.d$brs1_dist_correlated-scn5a.cln.d$brs1_dist_sequence)^2))

save(scn5a.cln.d, file="all.brs1.data.trunc.test.Rdata")
 #this file has all the inverse distance data in it 
...
This chunk saves two functions into the environment relevant for the forest plot. 
```{r}
...
This chunk creates the forest plot. 
```{r}
#load("all.brs1.data.trunc.Rdata")
load("all.brs1.data.trunc.test.Rdata")
scn5a.cln.d <- scn5a.cln.d[,!names(scn5a.cln.d) %in%  "cardiacboost"]
scn5a.cln.d <- unique(scn5a.cln.d)
results.1.data<-scn5a.cln.d[!is.na(scn5a.cln.d$provean_score) & !is.na(scn5a.cln.d$REVEL) & !is.na(scn5a.cln.d$pamscore) &!is.na(scn5a.cln.d$rmsf),]
...
xList=c('pph2_prob', 'provean_score', "blastpssm",
        'pamscore', "brs1_dist",'brs1_dist_sequence', 'brs1_dist_correlated',"brs1_dist_inverse", 'brs1_dist_inverse_cor',"brs1_dist_2inverse", 'brs1_dist_2inverse_cor',"brs1_dist_5inverse", 'brs1_dist_5inverse_cor', "REVEL", "rmsf")
...
tmp<-scn5a.cln.d[!is.na(scn5a.cln.d$provean_score) & !is.na(scn5a.cln.d$REVEL) & !is.na(scn5a.cln.d$pamscore) & !is.na(scn5a.cln.d$rmsf),]

 
# # Weighted R2 between observed LQT2 penetrance and post-test probability
##this is part of p_mean_w -L
...
tmp2<-scn5a.cln.d[!is.na(scn5a.cln.d$provean_score) & !is.na(scn5a.cln.d$brs1_penetrance) & !is.na(scn5a.cln.d$brs1_dist) & !is.na(scn5a.cln.d$REVEL) & !is.na(scn5a.cln.d$rmsf),]
...
This chunk is the ROC plot for multiple observations.
```{r, echo=FALSE, warning=FALSE, message=FALSE}
#load("all.brs1.data.trunc.Rdata")
...
modfunc6 <- glm(brs1_patho~rmsf, data = fglm, family = 'binomial')
modfunc7 <- glm(brs1_patho~brs1_dist_sequence+brs1_dist_correlated, data = fglm, family = 'binomial')
#from the graph, you cant see brs1_dist because its the same as combined_dist which is brs1_dist_sequence + brs1_dist_correlated 
...
names<- c("pph2_prob:", "REVEL:", "blastpssm:", "SIFT_score:", "brs1_dist:", "rmsf:", "combined_dist:")
...
Pr Curve for multiple observations, Recently it has been buggy. 
```{r, echo=FALSE, warning=FALSE, message=FALSE}

df <- data.frame(fglm$pph2_prob, fglm$REVEL, fglm$blastpssm, fglm$SIFT_score, fglm$brs1_dist, fglm$rmsf, fglm$brs1_dist_sequence+fglm$brs1_dist_correlated)
...
fglm$combined_dist <- (fglm$brs1_dist_sequence+fglm$brs1_dist_correlated)
dist.only <- 0
blast1 <- 0
polyphen1 <- 0
SIFT_score <- 0
...
for (co in cutoffs){
  ...
  if (!sum(fglm$brs1_patho)<6){
    ...
    test[i]<- glm.mod(fglm, "combined_dist") 
    #test is brs1_dist_sequence + brs1_dist_correlated could add one thats * instead of + if need be 
  }
}
...
lines(cutoffs[1:i],rmsf,col=colrs[5]) # black
lines(cutoffs[1:i],test,col=colrs[6]) # grey
```

## Observed cohort BRS1 diagnosis probability with single observation variants.
## ROC Plot
ROC plot for single observations
```{r, echo=FALSE, warning=FALSE, message=FALSE}
...
names<- c("pph2_prob:", "REVEL:", "blastpssm:","SIFT_score:", "brs1_dist:", "rmsf:")
#added for legend
auc <- round(auc, digits = 2)
leg.data <-data.frame(names,auc)
leg.data$together <- paste(leg.data$names, leg.data$auc)
...
###PR Curve
PR curve for single observations.
```{r, echo=FALSE, warning=FALSE, message=FALSE, include=TRUE}

df <- data.frame(fglm$pph2_prob, fglm$REVEL, fglm$blastpssm, fglm$SIFT_score, fglm$brs1_dist.x, fglm$rmsf)
...
AUC curve for single observations
```{r, echo=FALSE, warning=FALSE, message=FALSE}
...
fglm<-n1[!is.na(n1$brs1_patho) & !is.na(n1$blast_pssm) & n1$total_carriers == 1,]
dist.only <- 0
blast1 <- 0
polyphen1 <- 0
RMSF <- 0
...
The last four chunks are another set of graphs, to use you'd need to change it to brs1 instead of lqt2.  

## Forest Plot with only lqt2_dist data 
This chunk is code for another forest plot- it was used for the isolated lqt2 data in the other code. 
```{r preamble,}
